...
Registration
============
The registration type is specified by the -r/--regtype flag and is required. Two types of registration procedures are supported by pet2mri:
...
If using boundary-based registration, the contrast must also be specified with the -c/--contrast flag. Possible values
